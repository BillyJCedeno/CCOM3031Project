---
title: "Billy J Cedeño Nazario, Jean G. Collazo y Andrel"
...
1. How many cell-lines are contained in the data? There are a total of 43427 cell-lines. 
```{r}
summary(rawPharmacoData)
```

2. What drug concentrations were used in each study? 
```{r}
table(rawPharmacoData$drug)
```
